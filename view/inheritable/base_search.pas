...
type
  ...
  protected
    ...
    function ValidaSetRegister:Boolean;Virtual;
...
begin
  Lb_ResultadoPesquisa.Caption := 'Resultado da pesquisa : ' + IntTostr( cds_search.recordCount) + ' registro(s)';
  Repaint;
end;
...
function TBaseSearch.ValidaSetRegister: Boolean;
begin
  Result := True;
end;
