...
uses System.Classes, STQuery, System.SysUtils,ControllerBase,tblCtrlEstoque ,
      Un_MSg, System.Generics.Collections,FireDAC.Stan.Param;

Type
  TListaCtrEstoque = TObjectList<TCtrlEstoque>;

  TProdutoSimples = class(TComponent)
    private
    FCodigo: Integer;
    FEstoque: Integer;
    FComposicao: String;
  ...
  TProdutoMovimentado = class(TComponent)
    private
    FCodigo: Integer;
    procedure setFCodigo(const Value: Integer);
    public
...
Begin
  ...
  Try
    ...
    Begin
      ...
      while not eof do
      Begin
        LcItem := TProdutoSimples.create(Self);
...
Begin
  ...
  Try
    ...
    Begin
      ...
      while not eof do
      Begin
        LcItem := TProdutoMovimentado.create(Self);
        LcItem.Codigo := FieldByName('PRO_CODIGO').AsInteger;
